...
<div class="wrapper">
  <div class="container">
    <div class="whitebox">
      ...
      <h3>Statistics are not updated in real time. To start, you will have to manually <a href="honeyd-viz-generator.php">GENERATE_THE_HONEYD_GRAPHS();</a></h3>
	  <p><hr></p>
	  ...
	  <p>Version 0.2:<br/>+ Cleaned honeyd-viz-generator.php.<br/>+ Added most connections per day chart.<br/>+ Added connections per day chart.<br/>+ Added connections per week chart.</p>

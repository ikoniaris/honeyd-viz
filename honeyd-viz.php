...
<div class="wrapper">
  <div class="container">
    <div class="whitebox">
      <!-- ############################# -->
	  <h2>Simple and useful graphical statistics generated from your Honeyd honeypot<br/>For more, visit the other pages/components of this package</h2> 
      <div class="portfolio">
        <div class="fl_left">
      ...
      <div class="portfolio">
        <div class="fl_left">
          ...
          <p>This horizontal bar chart diplays the most conncetions per day (Top 20) against the honeypot system.</p>
        </div>
        <div class="fl_right"><img src="generated-graphs/most_connections_per_day.png" alt="" /></div>
		<div class="fl_left">
          <p>This line chart diplays the daily activity on the honeypot system. Spikes indicate connection events.<br/><br/><strong>Warning:</strong> Dates with zero connections are not displayed.</p>
        </div>
        <div class="fl_right"><img src="generated-graphs/connections_per_day.png" alt="" /></div>
		<div class="fl_left">
          <p>This line chart diplays the weekly activity on the honeypot system. Curves indicate connection attempts over a weekly period.</p>
        </div>
      ...
      <div class="portfolio">
        <div class="fl_left">
          ...
          <p>This vertical bar chart diplays the top 10 unique IPs ordered by the number of TCP connections to the system.</p>
        </div>
        <div class="fl_right"><img src="generated-graphs/tcp_connections_per_ip.png" alt="" /></div>
        <div class="fl_left">
          <p>This pie chart diplays the top 10 unique IPs ordered by the number of TCP connections to the system.</p>
        </div>
      ...
      <div class="portfolio">
        <div class="fl_left">
          ...
          <p>This vertical bar chart diplays the top 10 unique IPs ordered by the number of UDP connections to the system.</p>
        </div>
        <div class="fl_right"><img src="generated-graphs/udp_connections_per_ip.png" alt="" /></div>
        <div class="fl_left">
          <p>This pie chart diplays the top 10 unique IPs ordered by the number of UDP connections to the system.</p>
        </div>
      ...
      <div class="portfolio">
        <div class="fl_left">
          ...
          <p>This vertical bar chart diplays the top 10 unique IPs ordered by the number of ICMP connections to the system.</p>
        </div>
        <div class="fl_right"><img src="generated-graphs/icmp_connections_per_ip.png" alt="" /></div>
        <div class="fl_left">
          <p>This pie chart diplays the top 10 unique IPs ordered by the number of ICMP connections to the system.</p>
        </div>
